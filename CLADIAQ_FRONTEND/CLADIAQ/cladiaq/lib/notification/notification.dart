...
class NotificationCq extends StatefulWidget {
  @override
  _NotificationCqState createState() => _NotificationCqState();
}

class _NotificationCqState extends State<NotificationCq> {
